...
<aside id="left-panel">
    ...
    <nav>
        ...
        <ul>
            ...
            <li>
                <a href="#"><i class="fa fa-lg fa-fw fa-gears"></i> <span class="menu-item-parent">Beheer</span></a>
                <ul>
                    <li>
                        <a href="/ajax/manage/schools.html">Scholen</a>
                    </li>
                    <li>
                        <a href="/ajax/manage/users.html">Gebruikers</a>
                    </li>
                </ul>
            </li>
            <li>
